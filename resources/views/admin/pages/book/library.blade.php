...
@section('title','مدیریت - کتاب های خریداری شده')
...
<nav aria-label="breadcrumb mb-3">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">فهرست محصولات خریداری شده</li>
    </ol>
</nav>
...
<div class="card">
   ...
   <div class="pricing-plans pb-sm-5 pb-2 rounded-top">
     <div class="container py-5">
        @if($books->isEmpty())
            <h2 class="text-center">شما هیچ کتابی را خریداری نکرده اید!</h2>
        @endif
           ...
           <div class="card border border-2 border-primary">
             <div class="card-body">
               ...
               <ul class="list-unstyled pt-2 pb-1 lh-1-85">
                 ...
                 <a  class="btn btn-primary d-grid w-100">دانلود کتاب</a>
             </div>
           </div>
         </div>
